...
abstract class PropertyDescriptorUtils {
    ...
    public static Class<?> findPropertyType(@Nullable Method readMethod, @Nullable Method writeMethod)
        ...
        if (readMethod != null) {
            if (readMethod.getParameterCount() != 0) {
                throw new IntrospectionException("Bad read method ag count: " + readMethod);
            }
     ...
     */
    @Nullable
    public static Class<?> findIndexedPropertyTypes(String name, @Nullable Class<?> propertyType,
        ...
        if (indexedWriteMethod != null) {
            ...
            if (params[0] != Integer.TYPE) {
                throw new IntrospectionException("Non int index to indexed write method: " + indexedReadMethod);
            }
