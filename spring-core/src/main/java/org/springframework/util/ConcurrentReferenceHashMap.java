...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    public ConcurrentReferenceHashMap(int initialCapacity) {
        this(initialCapacity, DEFAULT_INITIAL_CAPACITY, DEFAULT_CONCURRENCY_LEVEL, DEFAULT_REFERENCE_TYPE);
    }
    ...
    protected final float getSegmentsSize() {
     ...
     */
    @Nullable
    public final Reference<K, V> getReference(@Nullable Object key, Restructure restructure) {
