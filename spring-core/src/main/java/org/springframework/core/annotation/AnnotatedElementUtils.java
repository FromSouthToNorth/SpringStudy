...
public abstract class AnnotatedElementUtils {
    ...
    public static AnnotationAttributes getMergedAnnotationAttributes(AnnotatedElement element,
        ...
        MergedAnnotation<Annotation> mergedAnnotation = getAnnotations(element)
    ...
    public static <A extends Annotation> A getMergedAnnotation(AnnotatedElement element, Class<A> annotationType) {
        // Shortcut: directly present on the element, with on merging needed?
        if (AnnotationFilter.PLAIN.matches(annotationType) ||
                AnnotationsScanner.hasPlainJavaAnnotationsOnly(element)) {
    ...
    public static <A extends Annotation> Set<A> findAllMergedAnnotations(AnnotatedElement element, Class<A> annotationType) {
        return findAnnotations(element).stream(annotationType)
                .sorted(highAggregateIndexFirst())
                .collect(MergedAnnotationCollectors.toAnnotationSet());
    }
    ...
    private static <A extends Annotation> Comparator<MergedAnnotation<A>> highAggregateIndexFirst() {
    ...
    private static AnnotationAttributes getAnnotationAttributes(MergedAnnotation<?> annotation,
        ...
        return annotation.asAnnotationAttributes(
                Adapt.values(classValueAsString, nestedAnnotationsAsMap));
    }
