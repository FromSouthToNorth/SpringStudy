...
public abstract class MergedAnnotationPredicates {
    ...
    public static <A extends Annotation> Predicate<MergedAnnotation<A>> firstRunOf(
        ...
        return new FirsRunOfPredicate<>(valueExtractor);
    }
     ...
     */
    private static class FirsRunOfPredicate<A extends Annotation> implements Predicate<MergedAnnotation<A>> {
        ...
        FirsRunOfPredicate(Function<? super MergedAnnotation<A>, ?> valueExtractor) {
