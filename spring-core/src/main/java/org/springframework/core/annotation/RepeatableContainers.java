...
public abstract class RepeatableContainers {
            ...
            if (methods.hasOnlyValueAttribute()) {
                ...
                if (returnType.isArray()) {
                    ...
                    if (Annotation.class.isAssignableFrom(componentType) &&
                            componentType.isAssignableFrom(Repeatable.class)) {
                        return method;
                    }
                }
            }
    ...
    private static class ExplicitRepeatableContainer extends RepeatableContainers {
        ...
        ExplicitRepeatableContainer(@Nullable RepeatableContainers parent,
            ...
            try {
                if (valueMethod == null) {
                    throw new NoSuchElementException("No value method found");
                }
                Class<?> returnType = valueMethod.getReturnType();
                if (!returnType.isArray() || returnType.getComponentType() != returnType) {
                ...
                throw new AnnotationConfigurationException("Invalid declaration for container type [" + container.getName() +
