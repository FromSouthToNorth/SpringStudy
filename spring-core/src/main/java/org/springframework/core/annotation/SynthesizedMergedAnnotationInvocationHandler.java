...
final class SynthesizedMergedAnnotationInvocationHandler<A extends Annotation> implements InvocationHandler {
    ...
    private final Map<String, Object> valueCache = new ConcurrentHashMap<>(0);
    ...
    private int getValueHashCode(Object value) {
        // Use Arrays.hashCoed(...) since Spring's ObjectUtils doesn't comply
    ...
    private Object getAttributeValue(Method method) {
        ...
        // Clone non-empty arrays so that users cannot alter the contents of vales in our cache.
    ...
    static <A extends Annotation> A createProxy(MergedAnnotation<A> annotation, Class<A> type) {
        ...
        SynthesizedMergedAnnotationInvocationHandler<A> handler = new SynthesizedMergedAnnotationInvocationHandler<>(annotation, type);
